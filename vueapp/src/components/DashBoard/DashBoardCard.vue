<template>
    <div class="card">
        <div class="card-header no-border">
            <h5 class="card-title">{{ title ?? 'MOM' }}</h5>
        </div>
        <div class="card-body pt-0">
            <div class="widget-49">
                <div class="widget-49-title-wrapper">
                    <div class="widget-49-date-primary">
                        <span class="widget-49-date-day">{{ !date_day ? '09' : ((date_day) < 10 ? ('0' + date_day) : date_day) }}</span>
                        <span class="widget-49-date-month">{{ date_month ?? 'апр' }}</span>
                    </div>
